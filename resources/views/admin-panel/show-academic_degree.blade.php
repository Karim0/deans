    ...
    <div class="container">
            ...
            <div class="col-12">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">@lang('messages.academic_degree')</li>
                    </ol>
                </nav>
            </div>
        </div>
        <div class="row pt-3 pb-3">
            <button type="button" class="btn btn-primary"
                    data-toggle="modal" data-target="#add_academic_degrees">Добавить
            </button>
        </div>
                ...
                <tr>
                    ...
                    <td>
                        <a class="btn btn-primary text-white"
                           href="{{route('edit-academic_degree_page', ['id'=>$degree->id])}}"><i class="fa fa-edit"></i></a>
                        <a class="btn btn-danger text-white"
                           href="{{route('delete-academic_degree', ['id'=>$degree->id])}}"><i
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{route('add-academic_degree')}}" method="post">
                        @csrf
